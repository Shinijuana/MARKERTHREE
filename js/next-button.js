      ...
      if (!isVisible) {
        ...
        if (isLostModel) {
          if (nextButton) {
            ...
            nextButton.setAttribute('animation__move', 'property: position; from: 0 0 0; to: -1 0 0; dur: 1000; easing: linear');
          }
          if (phoneButton) {
            phoneButton.setAttribute('visible', 'true');
            phoneButton.setAttribute('animation__pulse', 'property: scale; from: 0 0 0; to: .5 .5 .5; dir: alternate; dur: 1000');
            phoneButton.setAttribute('animation__move', 'property: position; from: 0 0 0; to: 0 1 0; dur: 1000; easing: linear');
          }
          if (mailButton) {
            mailButton.setAttribute('visible', 'true');
            mailButton.setAttribute('animation__pulse', 'property: scale; from: 0 0 0; to: .5 .5 .5; dir: alternate; dur: 1000');
            mailButton.setAttribute('animation__move', 'property: position; from: 0 0 0; to: 1 0 0; dur: 1000; easing: linear');
          }
          if (vcfButton) {
            vcfButton.setAttribute('visible', 'true');
            vcfButton.setAttribute('animation__pulse', 'property: scale; from: 0 0 0; to: .5 .5 .5; dir: alternate; dur: 1000');
            vcfButton.setAttribute('animation__move', 'property: position; from: 0 0 0; to: 0 -1 0; dur: 1000; easing: linear');
          }
        }
      } else {
